...
test.describe.serial('staging visual regression', () => {
  ...
  test('missing-case page matches its snapshot', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('missing-case-page.png', {
      fullPage: true,
      mask: volatileUi(page),
      animations: 'disabled',
    })
  ...
  test('public-case page matches its snapshot', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('public-case-page.png', {
      fullPage: true,
      mask: volatileUi(page),
      animations: 'disabled',
    })
  ...
  test('sighting page matches its snapshot', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('sighting-page.png', {
      fullPage: true,
      mask: volatileUi(page),
      animations: 'disabled',
    })
  ...
  test('owner dashboard matches its snapshot', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('owner-dashboard-page.png', {
      fullPage: true,
      mask: volatileUi(page),
      animations: 'disabled',
    })
