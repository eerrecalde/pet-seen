...
function MissingCasePage() {
  ...
  const [draft, setDraft] = useState<{ id: string, petName: string } | null>(null)
  ...
  async function savePet(event: FormEvent<HTMLFormElement>) {
    ...
    setDraft({ id: caseDraft.id, petName }); setState('idle'); setStage('location')
  }
  ...
  return <div className="form-shell"><SimpleHeader /><main className="flow-layout">
