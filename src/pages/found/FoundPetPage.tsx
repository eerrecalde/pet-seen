...
export function FoundPetPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const { error: submitError } = await supabase.rpc('submit_found_pet_report', {
