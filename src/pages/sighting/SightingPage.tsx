...
export function SightingPage() {
  ...
  async function submit(event?: FormEvent<HTMLFormElement>) {
    ...
    if (submitError) {
      ...
      setState('error'); setError(submitError.message || t('sighting.submitError')); return
    }
