...
export function localeFromUrlSegment(segment: string | undefined): AppLocale | undefined {
...
const initialLocale = localeFromUrlSegment(window.location.pathname.split('/')[1]) ?? defaultLocale
