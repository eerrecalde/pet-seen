...
export async function enablePushNotifications(client: SupabaseClient, vapidPublicKey: string) {
  if (!pushNotificationsSupported()) throw new Error('Push notifications are not supported by this browser.')
