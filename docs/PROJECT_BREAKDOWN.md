...
| PS-305 | Configure a Cloudflare Pages staging deployment and temporary staging domain from `main`, using a separate hosted Supabase staging environment | In progress — repository automation and setup runbook added; account-level setup remains |
